...
#
# Given perfect knowledge of the sequence of cards in the deck, implement a blackjack solver that maximizes the 
# player's score (that is, wins minus losses).
