...
#
# Create a data structure that can efficiently convert a certain quantity of one unit to the correct amount of any 
# other unit. You should also allow for additional units to be added to the system.
