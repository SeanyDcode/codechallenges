...
#
# Grid cells are connected horizontally orvertically (not diagonally). The grid is completely surrounded by 
...
# guaranteed to be exactly one island in this grid, and the island doesn't have water inside that isn't 
# connected to the water around the island. Each cell has a side length of 1.
#
