...
#
# Daily Challenge #545
# Given a binary tree, find the lowest common ancestor (LCA) of two given nodes in the tree. Assume that
# each node in the tree also has a pointer to its parent.
#
