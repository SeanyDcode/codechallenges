...
#
# Daily Challenge #677
# The Sieve of Eratosthenes is an algorithm used to generate all prime numbers smaller than N. The method is to take increasingly larger 
# prime numbers, and mark their multiples as composite.
#
