...
# height of each stone increases by one until reaching the tallest stone, after which the heights decrease by one. In addition, 
# the start and end stones of the pyramid should each be one stone high.
#
